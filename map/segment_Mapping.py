...
from map.model import get_grid, ChannelPool
...
class Semantic_Mapping(nn.Module):
    ...
    def __init__(self, args, max_height=None, min_height=None, num_categories=None):
        ...
        self.to = torch.ones(args.num_processes, 1 + self.num_sem_categories,
                             self.screen_h // self.du_scale * self.screen_w // self.du_scale).float().to(self.device)
        self.feat = self.to
    ...
    def forward(self, obs, pose_obs, maps_last, poses_last):
        ...
        current_poses = pose_obs #get_new_pose_batch(poses_last, corrected_pose)
